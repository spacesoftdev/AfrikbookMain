            ...
            if invoice_id != "":
                if warehouse != "":   
                    ...
                    if stock_in_query.exists():
                        ...
                        CreateStockoutOrder.objects.filter(invoice_no=invoice_id, warehouse=warehouse, item=item_name[i]).update(stockout_status="Supplied")
                        ...
                        CreateStockoutOrder.objects.filter(warehouse=warehouse, item_code=itemcode[i]).update(stockout_status="Supplied")
