    ...
    function updateSales(res){
     ...
     function CancelSales(id){
        var UpdateCancelSales = document.getElementById('UpdateCancelSales').dataset.url;

        $.ajax({
            type: 'GET',
            url: UpdateCancelSales,
            data: {
                id:id 
            },
    ...
    $('#CSD').on('click',function() {
        ...
        var Search_for_sales = document.getElementById('Search_for_sales').dataset.url;

        $.ajax({
            type: 'GET',
            url: Search_for_sales,
            data: {
                fromdate: fromdate,   
                todate: todate, 
            },
